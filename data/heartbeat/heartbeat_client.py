...
class UDP_Client:
    ...
    def get_timestamp(self):
        try:
            ...
            #return year, month, day, hour, minute, second_millisecond
            return time_string

        except Exception as e:
            print(f"TIMESTAMP_ERROR: {e}")
            return None
    ...
    def send_heartbeat(self):
        ...
        try:
            # ONSTART 전송
            #year, month, day, hour, minute, second_millisecond = self.get_timestamp()
            time_string = self.get_timestamp()
            message = {
                "vehicleId": config.Vehicle,
