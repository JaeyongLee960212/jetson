    ...
    def run(self):
        while True:
            try:
                ...
                if message['sensorId'] == "ET_INFRA_MARWIS_CPU":
                    client_label = "NUVO"
                if message['sensorId'] == "ET_INFRA_TUNNELLUX_CPU":
                    client_label = "ODYSSEY"
                if message['sensorId'] == "ET_INFRA_VIDEOPROCESSING_JETSON":
                    client_label = "JETSON"
                if message['sensorId'] == "ET_INFRA_SURFACEPOTHOLE_CPU":
                    client_label = "LINE"
