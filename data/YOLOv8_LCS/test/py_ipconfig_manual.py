...
def example_entry_point():
	...
	new_ip_address = ipaddress.IPv4Address("192.168.10.116")
	new_subnet_mask = ipaddress.IPv4Address("255.255.255.0")

	nodemap = device.nodemap
	print(device)
	print(nodemap.get_node("GevPersistentIPAddress").value)
	print(nodemap.get_node("GevPersistentSubnetMask").value)
